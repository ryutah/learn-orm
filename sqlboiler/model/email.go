...
var EmailWhere = struct {
	...
	UserID: whereHelperint{field: "`email`.`user_id`"},
}
...
var (
	emailAllColumns            = []string{"email", "user_id"}
	emailColumnsWithoutDefault = []string{"email", "user_id"}
	emailColumnsWithDefault    = []string{}
	emailPrimaryKeyColumns     = []string{"email"}
)
...
func (q emailQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Email, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for email")
	}
...
func (q emailQuery) All(ctx context.Context, exec boil.ContextExecutor) (EmailSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to Email slice")
	}
...
func (q emailQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count email rows")
	}
...
func (q emailQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if email exists")
	}
...
func (o *Email) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	...
	updateQuery := fmt.Sprintf(
		"UPDATE `email` SET %s WHERE %s",
		strmangle.SetParamNames("`", "`", 0, []string{"user_id"}),
		strmangle.WhereClause("`", "`", 0, emailPrimaryKeyColumns),
	)
	values := []interface{}{related.ID, o.Email}
...
func FindEmail(ctx context.Context, exec boil.ContextExecutor, email string, selectCols ...string) (*Email, error) {
	emailObj := &Email{}
	...
	query := fmt.Sprintf(
		"select %s from `email` where `email`=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from email")
	}
...
func (o *Email) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no email provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into email")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for email")
	}
...
func (o *Email) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update email, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update email row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for email")
	}
...
func (q emailQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for email")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for email")
	}
...
func (o EmailSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in email slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all email")
	}
	return rowsAff, nil
}
...
func (o *Email) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no email provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("model: unable to upsert email, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for email")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for email")
	}
...
func (o *Email) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no Email provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from email")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for email")
	}
...
func (q emailQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no emailQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from email")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for email")
	}
...
func (o EmailSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from email slice")
	}
...
func (o *Email) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindEmail(ctx, exec, o.Email)
	if err != nil {
		return err
	}
...
func (o *EmailSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in EmailSlice")
	}
...
func EmailExists(ctx context.Context, exec boil.ContextExecutor, email string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `email` where `email`=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if email exists")
	}
